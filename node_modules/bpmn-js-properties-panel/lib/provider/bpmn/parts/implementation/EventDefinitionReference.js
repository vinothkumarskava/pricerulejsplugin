...
module.exports = function(element, definition, bpmnFactory, options) {
  ...
  if(options.addMultipleElements && options.inputArr)
  {
    forEach(options.inputArr, function(option) {
      ...
      //setOptionss(element, values, option);
    });
  }

  function setOptionss(element, values, option)
  {
    ...
    var command = commands.push(cmdHelper.updateBusinessObject(element, definition, props));
*/
